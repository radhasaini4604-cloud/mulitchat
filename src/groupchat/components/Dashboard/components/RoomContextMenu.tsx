...
export function RoomContextMenu({
  ...
  return createPortal(
    <div
      className={`room-dropdown ${isAllRoomsModalOpen ? 'in-modal' : ''}`}
      style={{
        position: 'fixed',
    ...
    >
      <button className="dropdown-item" onClick={onRename}>
        <svg className="dropdown-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" width="14" height="14">
      ...
      <button className="dropdown-item" onClick={onPin}>
        <PinIcon className="dropdown-item-icon" size={14} />
        {room.pinned === 1 ? 'Unpin' : 'Pin'}
      </button>
      <button className="dropdown-item" onClick={onSummarize}>
        <svg className="dropdown-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" width="14" height="14">
          <path d="M15 4H7" />
      ...
      <button className="dropdown-item" onClick={onRoomInfo}>
        <svg className="dropdown-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" width="14" height="14">
      ...
      <button className="dropdown-item delete" onClick={onDelete}>
        <svg className="dropdown-item-icon" viewBox="0 0 24.00 24.00" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="14" height="14">
