...
export function AuthModal({ isOpen, onClose, onAuthSuccess, defaultSignUp = false }: AuthModalProps) {
  ...
  const handleOAuth = async (provider: 'google' | 'github') => {
    ...
    try {
      ...
      setMessage({ text: err.message || 'An error occurred during social login.', type: 'error' });
      setLoading(false);
    }
  };
      ...
      <div className="auth-modal-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <footer className="auth-modal-footer">
          <span>
            ...
            <button type="button" className="auth-toggle-btn" onClick={() => { setIsSignUp(!isSignUp); setMessage(null); }}>
